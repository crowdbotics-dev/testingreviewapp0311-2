"""
Django settings for testingreviewapp0311_2 project.
...
ROOT_URLCONF = 'testingreviewapp0311_2.urls'
...
WSGI_APPLICATION = 'testingreviewapp0311_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestingReviewApp0311 Support <support@testingreviewapp0311-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testingreviewapp0311_2 API",
    "DESCRIPTION": "API documentation for testingreviewapp0311_2 App",
    "VERSION": "v1",
}
